...
$code2 = get_field('analytics_code_body', 'option');
echo $code2 ? "$code2" : "" ; ?>
<div id="page" class="site">
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="container">
			<div class="site-branding" style="background-color:<?=$main_color;?>;">
				<a href="<?php echo esc_url( home_url() ); ?>">
					<img src="<?php echo $logo ? "$logoURL" : esc_url( get_template_directory_uri() )."/img/logo.png";?>" alt="<?php bloginfo( 'name' ); ?>">
				</a>
			</div><!-- .site-branding --> 
